      ...
      <div className="relative z-10 container pt-48">
        ...
        <div className="flex flex-col md:flex-row flex-wrap">
          <div className="md:w-1/2 flex flex-col items-start justify-center gap-10 py-10 m-auto md:py-[5vw] md:mb-[-30px]">
            <p className="text-3xl md:text-4xl lg:text-5xl  text-primary font-semibold leading-tight md:leading-tight lg:leading-tight" data-aos="fade-right" data-aos-duration="1000">
              Sampah Rapih, Bumi Happy!
            </p>
            <div className="flex flex-col md:flex-row items-center gap-3 text-primary font-light" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
              <p>
